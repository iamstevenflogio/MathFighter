import Phaser from 'phaser'
 export default class MathFighterScene extends Phaser.Scene{
    ...
    init(){
        ...
        this.number = 0;        // to display the number clicked as the answer
        this.question = [] // to store the question array.
    ...
    create(){
        ...
        .setBounce(0.2)                 // Added a bounce effect when the Player fell on the Tile
        .setOffset(-20, -10);           //setOffset to make the player’s foot touch the tile
